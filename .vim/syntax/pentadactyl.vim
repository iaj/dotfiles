...
syn keyword pentadactylCommand ! run Ilistk[eys] Ilk Im[ap] Imapc[lear]
    \ Ino[remap] Iunm[ap] ab[breviate] abc[lear] addo[ns] ao au[tocmd] ba[ck]
    \ bd[elete] bw[ipeout] bun[load] tabc[lose] bma[rk] bmarks b[uffer] buffers
    \ files ls tabs ca[bbreviate] cabc[lear] cd chd[ir] clistk[eys] clk cm[ap]
    \ cmapc[lear] cno[remap] colo[rscheme] comc[lear] com[mand] comp[letions]
    \ contexts cookies ck cuna[bbreviate] cunm[ap] delbm[arks] delc[ommand]
    \ delmac[ros] delmapg[roup] delm[arks] delqm[arks] dels[tyle] dia[log]
    \ doautoa[ll] do[autocmd] downl[oads] dl ec[ho] echoe[rr] echom[sg] el[se]
    \ elsei[f] elif em[enu] en[dif] fi exe[cute] exta[dd] extde[lete]
    ...
    \ ha[rdcopy] h[elp] helpa[ll] hi[ghlight] hist[ory] hs ia[bbreviate]
    \ iabc[lear] if ilistk[eys] ilk im[ap] imapc[lear] ino[remap]
    \ iuna[bbreviate] iunm[ap] javas[cript] js jq ju[mps] keepa[lt] let
    \ listc[ommands] lc listk[eys] lk listo[ptions] lo loadplugins lpl macros
    \ map mapc[lear] mapg[roup] ma[rk] marks mes[sages] messc[lear]
    \ mkp[entadactylrc] mks[yntax] mlistk[eys] mlk mm[ap] mmapc[lear] mno[remap]
    \ munm[ap] nlistk[eys] nlk nm[ap] nmapc[lear] nno[remap] noh[lfind]
    \ no[remap] norm[al] nunm[ap] old-downl[oads] old-dl o[pen] pa[geinfo]
    \ pagest[yle] pas pref[erences] prefs pw[d] qma[rk] qmarks q[uit] quita[ll]
    \ qa[ll] redr[aw] reh[ash] re[load] reloada[ll] res[tart] runt[ime]
    \ sa[nitize] sav[eas] w[rite] sbcl[ose] scrip[tnames] se[t] setg[lobal]
    \ setl[ocal] sg sideb[ar] sb[ar] sbop[en] sil[ent] so[urce] stco[mment]
    \ stfe[tch] stfu[llscreen] stla[rge] stmu[te] st[op] stopa[ll] stpa[use]
    \ stpl[ay] stqu[ality] strel[ations] stre[peat] stse[ek] stvo[lume] sty[le]
    \ styled[isable] styd[isable] stylee[nable] stye[nable] stylet[oggle]
    \ styt[oggle] tab taba[ttach] tabde[tach] tabd[o] bufd[o] tabdu[plicate]
    ...
    \ bN[ext] tabr[ewind] tabfir[st] br[ewind] bf[irst] time tlistk[eys] tlk
    \ tm[ap] tmapc[lear] tno[remap] toolbarh[ide] tbh[ide] toolbars[how]
    \ tbs[how] toolbart[oggle] tbt[oggle] tunm[ap] una[bbreviate] u[ndo]
    \ undoa[ll] unl[et] unm[ap] verb[ose] ve[rsion] vie[wsource] vlistk[eys] vlk
    \ vm[ap] vmapc[lear] vno[remap] vunm[ap] winc[lose] wc[lose] wind[ow]
...
syn keyword pentadactylOption activate act altwildmode awim autocomplete au
    \ buftabs-completer btc buftabs-maxlength btm cdpath cd complete cpt
    \ cookieaccept ca cookielifetime cl cookies ck defsearch ds editor encoding
    \ enc eventignore ei extendedhinttags eht fileencoding fenc findcase fc
    ...
    \ loadplugins lpl mapleader ml maxitems messages msgs newtab nextpattern
    \ pageinfo pa passkeys pk popups pps previouspattern runtimepath rtp
    \ sanitizeitems si sanitizeshutdown ss sanitizetimespan sts scroll scr shell
    \ sh shellcmdflag shcf showstatuslinks ssli showtabline stal suggestengines
    \ tabclose tc tabopen to timeoutlen tmol titlestring urlseparator urlsep us
...
let s:toggleOptions = ["banghist", "bh", "buftabs", "bt", "buftabs-showicons",
    \ "btf", "errorbells", "eb", "exrc", "ex", "fullscreen", "fs", "hlfind",
    \ "hlf", "incfind", "if", "insertmode", "im", "jsdebugger", "jsd", "more",
    \ "online", "private", "pornmode", "showmode", "smd", "strictfocus", "sf",
