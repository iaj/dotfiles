...
" Borrowed From: Tomas Restrepo <tomas@winterdom.com>
"
...
if &t_Co > 255
   ...
   hi StatusLine      ctermfg=184 ctermbg=236   cterm=none
   ...
   " Ruby!
   hi rubyBlock        ctermfg=110
   hi rubyAccess       ctermfg=9                cterm=bold

   " HAML!
   hi hamlClass     ctermfg=174
   hi hamlId        ctermfg=148
end
